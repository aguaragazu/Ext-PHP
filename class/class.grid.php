...
class Grid extends msDB
{
     ...
     */
    public function setManualFilter($manualFilter)
    {
    ...
    public function getExtraFunction($field)
    {
    }
     ...
     */
    public function sendParam($REQUEST)
    {
        ...
        if (isset($REQUEST['dir'])) {
            $this->dir = ('DESC' == $REQUEST['dir']) ? 'DESC' : '';
        }
    ...
    public function buildList($list)
    {
        $tmp = array();
        foreach ($list as $arr) {
    ...
    public function add_always_column_avaible($column)
    {
        $field = array();
    ...
    public function buildField($fields)
    {
        $col_field = array();
        $col_value = array();
        $keyvalue = array();
    ...
    public function buildSingleJson($rs)
    {
        $the_col = array();
        while ($row = $rs->FetchNextObject()) {
            foreach ($row as $key => $x) {
    ...
    public function setIsArrayInput()
    {
     ...
     * @return json string
     */
    public function doCreate($dataInput)
    {
     ...
     * @return json string
     */
    public function doUpdate($dataInput)
    {
        $this->dataInput = $dataInput;
        $this->setIsArrayInput();
        $this->setKeyfield();
    ...
    public function buildUpdateQuerySelect($data)
    {
        $row = $this->buildField($data);
        $fields = $row['select'];
        $tmp = array();
    ...
    public function getLastRecordSql($data)
    {
    ...
    public function buildFieldUpdate()
    {
        $result = array();
    ...
    public function buildFieldInsert()
    {
        $result = array();
        $jsonInput = json_decode(stripslashes($this->dataInput));
        if ($this->isArrayInput) {
     ...
     * @return json string
     */
    public function doDestroy($dataInput)
    {
        $this->dataInput = $dataInput;
        $this->setIsArrayInput();
        $this->setKeyfield();
